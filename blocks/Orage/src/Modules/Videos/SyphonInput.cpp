...
namespace ogre {
    ...
    SyphonInput::SyphonInput( std::string name, vec2 origin, vec2 size, gl::Context * mMainWinCtx ) : ModuleVideo(name+" "+ tools.to_roman(SyphonInput::COUNT), origin, size, 0, 1, true){
