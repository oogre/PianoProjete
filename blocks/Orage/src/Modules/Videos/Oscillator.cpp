...
Oscillator::Oscillator( std::string name, vec2 origin, vec2 size, gl::Context * mMainWinCtx ) : ModuleVideo(name+" "+ tools.to_roman(Oscillator::COUNT), origin, size, 2, 2, true){
...
void Oscillator::setupUI(){
    ...
    tools.addSlider(mUi, "Hz", &(data.freq), 0.125f, 600.0f);
    tools.addSlider(mUi, "Sync", &(data.sync), 0.0f, 1.0f);
    ...
    tools.addSlider(mUi, "Trail", &(trail), 0.0f, 1.0f);
    
    mUi->addSpacer(false);
    mUi->addSpacer(false);
    
    tools.addSlider(mUi, "Sine", &(data.sine), 0.0f, 1.0f);
    tools.addSlider(mUi, "Rect", &(data.rect), 0.0f, 1.0f);
    tools.addSlider(mUi, "Saw", &(data.saw), 0.0f, 1.0f);
    tools.addSlider(mUi, "Tri", &(data.tri), 0.0f, 1.0f);
    tools.addSlider(mUi, "Noise", &(data.noise), 0.0f, 1.0f);
    tools.addSlider(mUi, "Exp", &(data.exp), 0.064f, 10.0f);
